  ...
  return (
    <body class='antialiased font-sans bg-gray-200'>
      <div class='container mx-auto px-4 sm:px-8'>
        <div class='py-8'>
          <div>
            <h2 class='text-2xl font-semibold leading-tight'>Staff members </h2>
          </div>
              ...
              <table class='min-w-full leading-normal'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                      <p class='text-gray-900 whitespace-no-wrap'>LAB-ASS</p>
                    </td>
                    <td class='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                      <p class='text-gray-900 whitespace-no-wrap'>
                       computer graphics
                  ...
                  <tr>
                    ...
                    <td class='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                      <p class='text-gray-900 whitespace-no-wrap'>HOD</p>
                    </td>
                    <td class='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                      <p class='text-gray-900 whitespace-no-wrap'>
                      operating system
